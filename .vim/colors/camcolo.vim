...
let s:palette.black  	 = [256, "#cccccc"]
...
let s:palette.orange 	 = [203, "#EEA52E"]
...
" PRIMITIVES
call s:HL('Boolean', s:palette.white, s:palette.black , 'none')
call s:HL('Character', s:palette.white, s:palette.black , 'none')
...
call s:HL('String', s:palette.darkyellow, s:palette.black , 'bold')
call s:HL('SpecialChar', s:palette.yellow, s:palette.black , 'none')
...
" LINES, COLUMNS
call s:HL('LineNr', s:palette.gray16, s:palette.black , 'none')
call s:HL('CursorLine', s:palette.white, s:palette.black, 'none')
call s:HL('CursorLineNr', s:palette.white, s:palette.blue, 'none')
...
" SEARCH
call s:HL('Search', s:palette.yellow, s:palette.black, 'none')
...
call s:HL('Include', s:palette.orange, s:palette.black , 'none')
call s:HL('Define', s:palette.orange, s:palette.black , 'none')
call s:HL('Macro', s:palette.orange, s:palette.black , 'none')
call s:HL('PreCondit', s:palette.orange, s:palette.black, 'none')
call s:HL('PreProc', s:palette.orange, s:palette.black, 'none')

" BINDINGS
call s:HL('Identifier', s:palette.darkgreen, s:palette.black, 'none')
call s:HL('Function', s:palette.darkgreen, s:palette.black, 'none')
call s:HL('Keyword', s:palette.darkgreen, s:palette.black, 'none')
call s:HL('Operator', s:palette.white, s:palette.black, 'none')

" TYPES
call s:HL('Type', s:palette.darkgreen, s:palette.black , 'none')
call s:HL('Typedef', s:palette.darkgreen, s:palette.black , 'none')
call s:HL('StorageClass', s:palette.blue, s:palette.black , 'none')
call s:HL('Structure', s:palette.darkgreen, s:palette.black , 'none')

" FLOW CONTROL
call s:HL('Statement', s:palette.orange, s:palette.black , 'none')
call s:HL('Conditional', s:palette.blue, s:palette.black , 'none')
call s:HL('Repeat', s:palette.blue, s:palette.black , 'none')
call s:HL('Label', s:palette.blue, s:palette.black , 'none')
call s:HL('Exception', s:palette.blue, s:palette.black , 'none')
...
call s:HL('Directory', s:palette.white, s:palette.black , 'bold')

" FOLD
call s:HL('FoldColumn', s:palette.pink, s:palette.black , 'none')
call s:HL('Folded', s:palette.pink, s:palette.black , 'none')
...
call s:HL('Delimiter', s:palette.yellow, s:palette.black , 'none')
call s:HL('Question', s:palette.white, s:palette.black, 'none')
call s:HL('Special', s:palette.yellow, s:palette.black , 'none')
...
call s:HL('Tag', s:palette.green, s:palette.black, 'none')
